<div class="biu-container">
    <div class="biu-container-inner">
        ...
        <h2><?php esc_html_e('Step 1: Choose folder in Google Drive', 'bulk_image_upload'); ?></h2>
        ...
        <?php } else { ?>
            ...
            <h2><?php esc_html_e('Step 2: Change the type of matching', 'bulk_image_upload'); ?></h2>
            ...
            <h2><?php esc_html_e('Step 3: See matching results', 'bulk_image_upload'); ?></h2>
